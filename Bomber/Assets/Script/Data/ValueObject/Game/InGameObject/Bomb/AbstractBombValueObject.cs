...
namespace Boomscape.Data.ValueObject.Game.InGameObject.Bomb
{
    public abstract class AbstractBombValueObject : AbstractGameObjectValueObject
    {
        ...
        public override KeyValuePair<Type, string> prefabData
        {
            get
            {
                return new KeyValuePair<Type, string>(typeof(GameObject), "Prefab/Bomb/" + code);
            }
        }

        public KeyValuePair<Type, string> iconPath
        {
            get
            {
                return new KeyValuePair<Type, string>(typeof(GameObject), "Prefab/UI/Icon/Bomb/" + code);
            }
        }
